...
public enum Mode {
  ...
  REGULAR_SEASON(25) {
    ...
    public ImmutableMultiset<Slot> getHittingSlots() {
      return ImmutableMultiset.of(
          Slot.C, Slot.C, Slot.SS, Slot.IF, Slot.IF, Slot.IF, Slot.IF, Slot.CF, Slot.OF, Slot.OF,
          Slot.OF, Slot.H, Slot.H, Slot.H);
    }

    @Override
    public ImmutableMultiset<Slot> getPitchingSlots() {
      return ImmutableMultiset.of(
          Slot.SP, Slot.SP, Slot.SP, Slot.SP, Slot.SP, Slot.MR, Slot.MR, Slot.MR, Slot.MR, Slot.P,
          Slot.P);
    }
  },
  EXPANDED(40) {
    ...
    public ImmutableMultiset<Slot> getHittingSlots() {
      ...
      expanded.addAll(ImmutableMultiset.of(Slot.C, Slot.SS, Slot.IF, Slot.IF, Slot.CF, Slot.OF, Slot.OF, Slot.H));
    ...
    public ImmutableMultiset<Slot> getPitchingSlots() {
      ...
      expanded.addAll(ImmutableMultiset.of(Slot.SP, Slot.SP, Slot.MR, Slot.MR, Slot.P, Slot.P));
  ...
  PLAYOFFS(25) {
    @Override
    public ImmutableMultiset<Slot> getHittingSlots() {
      Multiset<Slot> playoffs = HashMultiset.create(REGULAR_SEASON.getHittingSlots());
    ...
    @Override
    public ImmutableMultiset<Slot> getPitchingSlots() {
      Multiset<Slot> playoffs = HashMultiset.create(REGULAR_SEASON.getPitchingSlots());
  ...
  public ImmutableMultiset<Slot> getAllSlots() {
    return ImmutableMultiset.copyOf(Iterables.concat(getHittingSlots(), getPitchingSlots()));
  }
}
