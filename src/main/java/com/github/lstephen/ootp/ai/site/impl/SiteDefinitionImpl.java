...
public final class SiteDefinitionImpl implements SiteDefinition {
  ...
  private SiteDefinitionImpl(
      Version type, String name, String siteRoot, Id<Team> team, String league, int nTeams) {
  ...
  public static SiteDefinitionImpl ootp5(
      String name, String siteRoot, Id<Team> team, String league, int nTeams) {

    return new SiteDefinitionImpl(Version.OOTP5, name, siteRoot, team, league, nTeams);
  }

  public static SiteDefinitionImpl ootp6(
      String name, String siteRoot, Id<Team> team, String league, int nTeams) {

    return new SiteDefinitionImpl(Version.OOTP6, name, siteRoot, team, league, nTeams);
  }
}
