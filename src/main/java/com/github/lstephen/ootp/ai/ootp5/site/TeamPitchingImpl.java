...
public class TeamPitchingImpl extends SingleTeamStats<PitchingStats> {
  ...
  @Override
  protected ImmutableMap<Player, PitchingStats> extractStatsVsLeft(Document doc) {
  ...
  @Override
  protected ImmutableMap<Player, PitchingStats> extractStatsVsRight(Document doc) {
